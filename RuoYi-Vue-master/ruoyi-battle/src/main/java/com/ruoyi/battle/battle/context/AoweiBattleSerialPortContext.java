 ...
 * @author hongjiasen
 */
public class AoweiBattleSerialPortContext extends AbstractAoweiBattleContext {
    ...
    public AoweiBattleSerialPortContext(BattleEntity battleEntity
            , BattleBaseConfigEntity battleBaseConfigEntity
            , List<BattleTeamConfigEntity> battleTeamConfigEntityList, AoweiMapEntity mapEntity
    ...
    public AoweiBattleSerialPortContext(BattleEntity battleEntity
            , BattleBaseConfigEntity battleBaseConfigEntity
            , BaseMapEntity mapEntity, SerialPort serialPort, SerialPort virtualSerialPort
