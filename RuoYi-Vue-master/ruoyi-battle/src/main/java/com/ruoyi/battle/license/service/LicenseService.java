package com.ruoyi.battle.license.service;

import cn.hutool.system.oshi.OshiUtil;
import  com.ruoyi.battle.license.domain.LicenseEntity;
import  com.ruoyi.battle.license.domain.RegisterRequestDO;
import  com.ruoyi.battle.license.mapper.LicenseEntityMapper;
...
public class LicenseService {
    ...
    public void init() {
        if (Constant.ONLINE_MODE == singleMode) {
        ...
        } else if (Constant.STANDALONE_MODE == singleMode) {
            ...
            log.error("[license服务]：未知的模式{}，请先进行注册", singleMode);
        }
    }
