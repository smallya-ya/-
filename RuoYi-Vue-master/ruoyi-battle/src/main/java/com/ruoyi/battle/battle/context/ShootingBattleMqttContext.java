 ...
 * @author hongjiasen
 */
public class ShootingBattleMqttContext extends AbstractShootingBattleContext {
    ...
    public ShootingBattleMqttContext(BattleEntity battleEntity, BattleBaseConfigEntity battleBaseConfigEntity
    ...
    public ShootingBattleMqttContext(BattleEntity battleEntity, BattleBaseConfigEntity battleBaseConfigEntity
            , MapEntity mapEntity, List<BattleTeamConfigEntity2> battleTeamConfigEntityList2) {
        this.battleEntity = battleEntity;
        this.battleBaseConfigEntity = battleBaseConfigEntity;
